...
def integrated_status():
    ...
    return {
        ...
        "orchestrator": "financial_corporate_integrated_snapshot_v5_semantic_evidence_calibration",
        "providers": {
            ...
            **provider_status,
            ...
            "trade_control_signals": {"role": "semantically attributed company export-control, enforcement, diversion, and policy pressure"},
            ...
            "cyber_media_signals": {"role": "victim-attributed enterprise incidents separated from product, ecosystem, and general cyber context"},
        },
        "optional_env": [
        ...
        "scoring": {
            ...
            "dynamic_hazards": "cross_module_dynamic_hazard_enrichment_v6_semantic_evidence_attribution",
            ...
            "trade_control_attribution": "company_trade_control_semantic_attribution_v3",
            "cyber_media_context": "company_cyber_media_semantic_context_v3",
        },
        ...
        "evidence_rules": [
            ...
            "Cyber media distinguishes direct enterprise incidents, product security, ecosystem incidents, and general company context.",
            "Direct OFAC designation screening is separate from export-control media pressure.",
            "Export-control reporting is classified into direct sanctions designation, compliance enforcement, direct restriction, downstream diversion, and policy context.",
            "Downstream diversion reporting cannot by itself imply company misconduct or sanctions non-compliance.",
